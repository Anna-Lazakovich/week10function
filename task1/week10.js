...
function getName(guestName = "Гость") {
    return (`Привет, ${guestName}!`);
}

console.log(getName("Анна"));
...
function calculateAge() {
    console.log ("Моему другу сейчас " + (currentYear - friendYearOfBirth) + " лет");
}
...
const myAge = (yearOfBorn) => {
    return currentYear - yearOfBorn;
}

console.log ("Мой возраст: " + myAge(1998));
